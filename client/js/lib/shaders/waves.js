const main_waves = {
   vertexShader: `
      ...
      void main() {
         ...
         pos.y = exp(-abs(freq * pos.x)) * sin(pos.x * 2.) * amp * noiseValue;
         pos.z += noiseValue * .4;
   ...
   fragmentShader: `
      ...
      void main() {
         float gradient = smoothstep(OFFSET, 1. + OFFSET, vX * 0.1);
         vec3 color = mix(u_color_1, u_color_2, gradient);
